...
import { exampleSuiteGraphAscension } from "./example-suite.graph.ascension.bundle.js";

export default function ExampleSuiteGraphAscensionReact() {
  const graph = exampleSuiteGraphAscension();

  return (
    <div style={{ fontFamily: "sans-serif", padding: 20 }}>
      <h1>RTT/1 Example Suite Graph (Ascension)</h1>
      ...
      <AscentVectorBlock vector={graph.ascent_vector} />
...
function AscentVectorBlock({ vector }) {
  return (
    <div style={panel}>
      <h2>Ascent Vector</h2>
      <pre style={pre}>{JSON.stringify(vector, null, 2)}</pre>
    </div>
  );
}
