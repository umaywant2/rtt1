...
import { exampleSuiteGraphSingularity } from "./example-suite.graph.singularity.bundle.js";

export default function ExampleSuiteGraphSingularityReact() {
  const graph = exampleSuiteGraphSingularity();

  return (
    <div style={{ fontFamily: "sans-serif", padding: 20 }}>
      <h1>RTT/1 Example Suite Graph (Singularity)</h1>
