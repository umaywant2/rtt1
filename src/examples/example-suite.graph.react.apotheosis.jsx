...
import { exampleSuiteGraphApotheosis } from "./example-suite.graph.apotheosis.bundle.js";

export default function ExampleSuiteGraphApotheosisReact() {
  const graph = exampleSuiteGraphApotheosis();

  return (
    <div style={{ fontFamily: "sans-serif", padding: 20 }}>
      <h1>RTT/1 Example Suite Graph (Apotheosis)</h1>
