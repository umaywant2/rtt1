...
import { exampleSuiteGraphUltra } from "./example-suite.graph.ultra.min.bundle.js";

export default function ExampleSuiteGraphAbsoluteReact() {
  const graph = exampleSuiteGraphUltra();

  return (
    <div style={{ fontFamily: "sans-serif", padding: 20 }}>
      <h1>RTT/1 Example Suite Graph (Absolute)</h1>
