...
import { exampleSuiteGraphOmega } from "./example-suite.graph.omega.bundle.js";

export default function ExampleSuiteGraphOmegaReact() {
  const graph = exampleSuiteGraphOmega();

  return (
    <div style={{ fontFamily: "sans-serif", padding: 20 }}>
      <h1>RTT/1 Example Suite Graph (Omega)</h1>
